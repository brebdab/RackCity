    ...
    return (
      <div className={"bp3-heading"}>
        <Card elevation={Elevation.ONE}>
          ...
          <Card elevation={Elevation.THREE}>
            ...
            <ol className={"bp3-list"}>
              <li>Fields:
                  ...
                  <li>rack: required for new assets, otherwise optional; string; address is by row letter (A-Z) then rack number (positive integer); There is no separator between row letter and rack number</li>
                  <li>rack_position: required for new assets, otherwise optional; positive integer; refers to vertical location in U of bottom of equipment</li>
                  <li>vendor: required for new assets, otherwise optional; string; refers to vendor of the model with which this asset is associated</li>
                  <li>model_number: required for new assets, otherwise optional; string; refers to model number of the model with which this asset is associated. Together with vendor uniquely identifies a model</li>
          ...
          <h4>Notes:</h4>
          <ol className={"bp3-list"}>
            <li>It is not possible to use the bulk import feature to modify a field marked "required always." Any attempt to do so will result in a new model/asset being created</li>
