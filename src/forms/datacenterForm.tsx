...
class DatacenterForm extends React.Component<DatacenterFormProps, DatacenterFormState> {
    ...
    render() {
        ...
        return (
            <div className={Classes.DARK + " login-container"}>
                ...
                >
                    <FormGroup label="Name (required)" inline={false}>
                        <Field
                            field="name"
                            placeholder="name"
                            value={values.name}
                    ...
                    <FormGroup label="Abbreviation (required - up to 6 characters)" inline={false}>
                        <Field
