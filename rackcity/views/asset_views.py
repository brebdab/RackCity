...
def asset_add(request):  # need to make network ports and power ports here
    """
    Add a new asset.
    """
...
@api_view(['POST'])
@permission_classes([IsAdminUser])
# need to modify network ports (mac address and connections) and power ports (connections)
...
@api_view(['POST'])
@permission_classes([IsAdminUser])
def asset_delete(request):  # need to delete network ports and power ports here
    """
...
@api_view(['POST'])
@permission_classes([IsAdminUser])
def asset_bulk_upload(request):  # need to make network ports and power ports here
    """
...
@api_view(['POST'])
@permission_classes([IsAdminUser])
def asset_bulk_approve(request):  # need to make network ports and power ports here
    """
