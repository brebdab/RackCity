...
def netid_login(request):
    ...
    if 'access_token' not in request.data:
        return JsonResponse(
            {
                "failure_message": UserFailure.LOGIN + UserFailure.NETID,
...
def user_many(request):
    ...
    if len(errors) > 0:
        return JsonResponse(
            {
                "failure_message": UserFailure.GET + GenericFailure.UNKNOWN,
                "errors": " ".join(errors)
            },
            status=HTTPStatus.BAD_REQUEST,
        )
    ...
    try:
        ...
        return JsonResponse(
            {
                "failure_message": UserFailure.GET + GenericFailure.FILTER,
                "errors": str(error)
            },
            status=HTTPStatus.BAD_REQUEST
        )
    ...
    try:
        ...
        return JsonResponse(
            {
                "failure_message": UserFailure.GET + GenericFailure.SORT,
                "errors": str(error)
            },
            status=HTTPStatus.BAD_REQUEST
        )
    ...
    if should_paginate:
        ...
        try:
            ...
            return JsonResponse(
                {
                    "failure_message":
                        UserFailure.GET + GenericFailure.UNKNOWN,
                    "errors": str(error)
                },
                status=HTTPStatus.BAD_REQUEST,
            )
...
def user_delete(request):
    ...
    if 'id' not in data:
        return JsonResponse(
            {
                "failure_message":
                    UserFailure.DELETE + GenericFailure.UNKNOWN,
        ...
        return JsonResponse(
            {
                "failure_message":
                    UserFailure.DELETE +
                    "User" + GenericFailure.DOES_NOT_EXIST,
    ...
    if username == 'admin':
        return JsonResponse(
            {
                "failure_message":
                    UserFailure.DELETE + "Not allowed to delete user 'admin'",
            },
            status=HTTPStatus.BAD_REQUEST,
        )
    try:
...
def user_grant_admin(request):
    ...
    if 'id' not in data:
        return JsonResponse(
            {
                "failure_message":
                    UserFailure.GRANT_ADMIN + GenericFailure.UNKNOWN,
                "errors":
...
def user_revoke_admin(request):
    ...
    if 'id' not in data:
        return JsonResponse(
            {
                "failure_message":
                    UserFailure.REVOKE_ADMIN + GenericFailure.UNKNOWN,
