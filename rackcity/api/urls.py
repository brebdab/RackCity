...
urlpatterns = [
    ...
    path("assets/bulk-export-offline", views.asset_bulk_export_offline),
    ...
    path("report/global", views.report_rack_usage_global),
    path("report/datacenter/<int:id>", views.report_rack_usage_datacenter),
