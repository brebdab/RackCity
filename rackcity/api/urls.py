...
urlpatterns = [
    ...
    path("power/get-state/<int:id>", views.pdu_power_status),
    path("power/mask-on", views.pdu_power_on),
    path("power/mask-off", views.pdu_power_off),
    path("power/cycle", views.pdu_power_cycle),
    path("power/availability", views.pdu_power_availability),
