# Generated by Django 3.0.2 on 2020-02-15 05:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostname', models.CharField(max_length=150, unique=True,
                                              validators=[rackcity.models.asset.validate_hostname])),
                ('elevation', models.PositiveIntegerField()),
                ('owner', models.CharField(blank=True, max_length=150, null=True,
                                           validators=[rackcity.models.asset.validate_owner])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_color', models.CharField(default='#394B59', max_length=7,
                                                   validators=[rackcity.models.it_model.validate_display_color])),
                ('network_ports', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(max_length=150), blank=True, null=True, size=None)),
                ('num_power_ports', rackcity.models.fields.rackcity_model_fields.RCPositiveIntegerField(
                    blank=True, null=True)),
                ('cpu', models.CharField(blank=True, max_length=150, null=True)),
                ('memory_gb', rackcity.models.fields.rackcity_model_fields.RCPositiveIntegerField(
                    blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('row_letter', models.CharField(max_length=1,
                                                validators=[rackcity.models.rack.validate_row_letter])),
                ...
                ('datacenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 to='rackcity.Datacenter', verbose_name='datacenter')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=(
                'datacenter', 'row_letter', 'rack_num'), name='unique rack letter and number per datacenter'),
        ),
    ]
